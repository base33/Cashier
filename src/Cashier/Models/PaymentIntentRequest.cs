...
namespace Cashier.Models
{
    public class PaymentIntentRequest
    {
        ...
        public static PaymentIntentRequest CreateCardPayment(string transactionReference, string description, double amount, string customerEmail, string confirmationPageUrl, string failurePageUrl, string callbackUrl, string additionalData)
        {
